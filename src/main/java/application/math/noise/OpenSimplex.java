...
public class OpenSimplex extends NoiseGenerator {
    ...
    private static final double STRETCH_CONSTANT_2D = (1.0 / Math.sqrt(2.0 + 1.0) - 1.0) / 2.0;
    private static final double SQUISH_CONSTANT_2D  = (Math.sqrt(2.0 + 1.0) - 1.0) / 2.0;
    private static final double STRETCH_CONSTANT_3D = (1 / Math.sqrt(3.0 + 1.0) - 1.0) / 3.0;
    private static final double SQUISH_CONSTANT_3D  = (Math.sqrt(3.0 + 1.0) - 1.0) / 3.0;
